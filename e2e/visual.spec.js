...
test.describe('Visual regression — studio-grotesque-redesign', () => {
  ...
  test('footer wordmark uses Outfit at 900 weight', async ({ page }) => {
    await page.setViewportSize({ width: 1440, height: 900 });
    await page.goto('/', { waitUntil: 'networkidle' });
